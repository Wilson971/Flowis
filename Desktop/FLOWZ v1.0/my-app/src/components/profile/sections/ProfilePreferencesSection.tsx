      ...
      <motion.div variants={motionTokens.variants.staggerItem}>
        <SettingsCard className="space-y-4">
          <SettingsHeader
            ...
            description="Clair ou sombre selon votre préférence."
          />
          ...
          <div className="grid grid-cols-2 gap-3">
            {[
              ...
              >
                <mode.icon className={cn("w-5 h-5", theme === mode.id ? "text-foreground" : "text-muted-foreground")} />
                <span className={cn("text-xs font-semibold", theme === mode.id ? "text-foreground" : "text-muted-foreground")}>
                  {mode.name}
                </span>
              </button>
            ))}
      ...
      <motion.div variants={motionTokens.variants.staggerItem}>
        <SettingsCard className="space-y-4">
          <SettingsHeader
            ...
            description="Choisissez la couleur principale de l'interface."
          />
      ...
      <motion.div variants={motionTokens.variants.staggerItem}>
        <SettingsCard className="space-y-4">
          <SettingsHeader
            ...
            description="Arrondis des composants."
          >
