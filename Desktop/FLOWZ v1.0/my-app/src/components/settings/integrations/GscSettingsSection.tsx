...
function SiteAutoIndexSettings({ siteId, siteUrl }: { siteId: string; siteUrl: string }) {
    ...
    useEffect(() => {
        ...
        setDirty(false);
    }, [settings.auto_index_new, settings.auto_index_updated]);

    const handleToggleNew = (val: boolean) => {
        setAutoNew(val);
        setDirty(true);
    };

    const handleToggleUpdated = (val: boolean) => {
        setAutoUpdated(val);
        setDirty(true);
    };
        ...
        <div className="pt-3 mt-3 border-t border-border/10 space-y-3">
            ...
            <div className="space-y-2.5">
                <div className="flex items-start justify-between gap-4">
                    ...
                    <Switch checked={autoNew} onCheckedChange={handleToggleNew} className="shrink-0 mt-0.5" />
                </div>
                ...
                <div className="flex items-start justify-between gap-4">
                    ...
                    <Switch checked={autoUpdated} onCheckedChange={handleToggleUpdated} className="shrink-0 mt-0.5" />
                </div>
            </div>
...
export default function GscSettingsSection() {
    const {
        connections,
        activeConnection,
        isLoading,
    ...
    // Inline confirm state — avoids nested Dialog/AlertDialog Radix conflict
