                ...
                <CardHeader className="pb-4 border-b border-border/10 mb-2 px-5 relative z-10">
                    <div className="flex items-center gap-3">
                        <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-muted/60 ring-1 ring-border/50 shrink-0">
                            <Link2 className="h-[18px] w-[18px] text-foreground/70" />
                        </div>
                        <div>
                    ...
                    <Tabs defaultValue="upsell" className="w-full">
                        ...
                        <TabsContent value="upsell" className="space-y-3 mt-0">
                            <div className="space-y-1.5">
                                <Label className="text-xs font-semibold tracking-tight flex items-center gap-2">
                        ...
                        <TabsContent value="related" className="space-y-3 mt-0">
                            <div className="space-y-1.5">
                                <Label className="text-xs font-semibold tracking-tight flex items-center gap-2">
                                    <Shuffle className="h-3 w-3 text-foreground/70" />
                                    Produits similaires
                                </Label>
                                <p className="text-[10px] text-muted-foreground">
